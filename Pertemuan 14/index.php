                ...
                <div class="col sm-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <?php
                            $result = mysqli_query($koneksi, "SELECT * FROM tma ORDER BY id_tma DESC");
                            ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $item['waktu'] ?></td>
                                            <td>
                                                <a class="btn btn-info" href="" onclick="showInfo(<?= $item['id_tma'] ?>)">Info</a>
                                                <a class="btn btn-danger" href="" onclick="deleteData('<?= $item['id_tma'] ?>')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
