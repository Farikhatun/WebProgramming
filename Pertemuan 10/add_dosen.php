    ...
    <div class="container" style="margin-top:20px">
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                $result = mysqli_query($koneksi, "INSERT INTO dosen(nama_dosen,nip,email) VALUES ('$varnama','$varnip','$varemail')");

                if($result){
                    echo '<br>Dosen berhasil ditambahkan! <a href="index_dosen.php" class="btn btn-primary btn-sm">View Dosen</a>';
                }
            }
        ?>
    </div>
